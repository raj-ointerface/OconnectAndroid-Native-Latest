...
/**
 * Created by AnthonyDoan on 5/29/17.
 */

public class NTEScheduleSwipeListAdapter extends BaseSwipeAdapter {
    ...
    public NTEScheduleSwipeListAdapter(Context context) {
        super();
    ...
    public View generateView(int position, ViewGroup parent) {
        ...
        */
        if (getItemViewType(position) == TYPE_SEPARATOR) {
            return mInflater.inflate(R.layout.nte_schedule_group_list_header, null);
        } else {
            return mInflater.inflate(R.layout.nte_schedule_group_list_child, null);
        }
    }
