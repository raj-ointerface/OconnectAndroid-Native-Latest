...
public class SinchService extends Service {
    ...
    private static final String APP_KEY = "57168fac-8abd-4317-820c-3e67ca5e225b";
    private static final String APP_SECRET = "HLPZ7cYRuk2OfcV+yYar9g==";
    ...
    public static SinchClient staticSinchClient;

    public SinchClient mSinchClient = null;
    ...
    private void start(String userName) {
        if (mSinchClient == null && userName != null && !userName.equalsIgnoreCase("")) {
